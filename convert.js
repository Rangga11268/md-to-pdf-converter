// convert.js — Root proxy handler untuk Vercel / Local server
// Meneruskan request ke PDF Server eksternal (Hugging Face Spaces)
...
module.exports = async (req, res) => {
    ...
    // URL PDF server eksternal — set via Environment Variable
